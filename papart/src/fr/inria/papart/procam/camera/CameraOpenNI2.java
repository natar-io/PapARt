...
public class CameraOpenNI2 extends CameraRGBIRDepth {
  ...
  class FrameListener implements VideoStream.NewFrameListener {
    ...
    public synchronized void onFrameReady(VideoStream stream) {
      ...
      // if (mImagePixels == null || mImagePixels.length < lastFrame.getWidth() *
      // lastFrame.getHeight()) {
      ...
      // System.out.println("CAM TREATMENT: " + Duration.between(initUpdate,
      // endUpdate).toMillis() + " milliseconds");
