...
public class KinectDepthAnalysis extends DepthAnalysis {
    ...
    public KinectDepthAnalysis(PApplet parent, CameraOpenKinect camera) {
        this.width = KINECT_WIDTH;
        this.height = KINECT_HEIGHT;
        this.size = KINECT_WIDTH * KINECT_HEIGHT;
    ...
    private void initMemory() {
        colorRaw = new byte[calibIR.getSize() * 3];
        depthRaw = new byte[calibIR.getSize() * 2];
