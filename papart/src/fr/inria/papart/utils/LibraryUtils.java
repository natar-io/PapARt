...
public class LibraryUtils {
  ...
  public static Process runExample(String exampleName, boolean silent) {
    try {
      ...
      commandLine.append("--sketch=").append(papartFolder).append(sketchFolder).append(" --output=")
          .append(papartFolder).append(sketchFolder).append("build").append(" --force --run");
      // commandLine.append("\"");
      // processing-java
      // --sketch=/home/jiii/papart/sketches/papartExamples/Kinect/MultiTouchKinect/
      // --output=/home/jiii/papart/sketches/papartExamples/Kinect/MultiTouchKinect/build
      // --force --run
