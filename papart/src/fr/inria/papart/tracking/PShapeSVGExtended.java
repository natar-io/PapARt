 ...
 * </PRE>
 */
public class PShapeSVGExtended extends PShape {
  XML element;
   ...
   */
  public PShapeSVGExtended(XML svg) {
    this(null, svg, true);
  ...
  protected PShapeSVGExtended(PShapeSVGExtended parent, XML properties, boolean parseKids) {
    setParent(parent);
  ...
  protected void setParent(PShapeSVGExtended parent) {
...
//      fillGradientPaint = parent.fillGradientPaint;
  ...
  protected PShapeSVGExtended createShape(PShapeSVGExtended parent, XML properties, boolean parseKids) {
    return new PShapeSVGExtended(parent, properties, parseKids);
  }
...
//    if (style == null) return table;
  ...
  static public class Gradient extends PShapeSVGExtended {
    ...
    public Gradient(PShapeSVGExtended parent, XML properties) {
  ...
  public class LinearGradient extends Gradient {
    ...
    public LinearGradient(PShapeSVGExtended parent, XML properties) {
  ...
  public class RadialGradient extends Gradient {
    ...
    public RadialGradient(PShapeSVGExtended parent, XML properties) {
      super(parent, properties);
...
//    // get location
  ...
  public static class Font extends PShapeSVGExtended {
    ...
    public Font(PShapeSVGExtended parent, XML properties) {
      super(parent, properties, false);
...
//          System.out.println("got missing glyph inside <font>");
  ...
  static class FontFace extends PShapeSVGExtended {
...
//    int horizAdvX;     // no dflt?
    ...
    public FontFace(PShapeSVGExtended parent, XML properties) {
      super(parent, properties, true);
  ...
  public static class FontGlyph extends PShapeSVGExtended {  // extends Path
    public String name;
    char unicode;
    int horizAdvX;

    public FontGlyph(PShapeSVGExtended parent, XML properties, Font font) {
      super(parent, properties, true);
      super.parsePath();  // ??
