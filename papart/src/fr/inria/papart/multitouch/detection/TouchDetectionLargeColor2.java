 ...
 */
public class TouchDetectionLargeColor2 extends TouchDetectionColor {

// set by calling function
    public TouchDetectionLargeColor2(WithSize imgSize) {
        super(imgSize);
    }
    ...
    public class CheckColorPoint implements PointValidityCondition {
        ...
        public boolean checkPoint(int offset, int currentPoint) {
            ...
            return !assignedPoints[offset] // not assigned  
                    && segmentedImage[offset] > TouchDetectionInnerCircles.UNKNOWN_COLOR // is a color/compo.
                    ;
//                    && dist < calib.getMaximumDistance();
    ...
    protected void setSearchParameters() {
        ...
        for (int i = 0; i < segmentedImage.length; i++) {
            if (segmentedImage[i] > TouchDetectionInnerCircles.UNKNOWN_COLOR) {
                this.toVisit.add(i);
            }
        }
