 ...
 */
public class TouchDepthWithColor extends TouchDetectionDepth {

    private final Compute2D touchRecognition;
    private final HashMap<Byte, ConnectedComponent> contactPoints;

    public TouchDepthWithColor(DepthAnalysisImpl depthAnalysisImpl, PlanarTouchCalibration calib) {
