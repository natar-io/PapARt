...
public class OBJModel {
    ...
    public OBJModelLite setupGLCreateLite() {
        ...
        OBJModelLite lite = new OBJModelLite(segments, materials, drawMode, parent);
    ...
    public void setupGLModel(GL gl) {

        Segment tmpModelSegment;
        Material mtl;

//        GLModel glmodel = new GLModel(parent, getFaceCount() * 3, PApplet.TRIANGLES, GLModel.DYNAMIC);
...
//            PVector[] fverts = getFaceVertices(f);
...
//        glmodel.endUpdateVertices();
        ...
        // copy TexCoords from OBJModel to GLModel
        ...
        // A texture with different names could be loaded more than one time...

//        glmodel.initTextures(texCount);
//
//        for(Segment segment : segments){
//
//            materials.get(segment.materialName);
//            glmodel.setTexture(0, null);
//
//        }
//
//        for(int i=0; i < texCount; i++){
//           glmodel.setTexture(i, null);
//        }
    ...
    public void drawGL() {
        ...
        for (int i = 0; i < segments.size(); i++) {
            ...
            if (tmpModelSegment.getFaceCount() != 0) { // again with the
                ...
                mtl.beginDrawGL(gl, useMaterial, useTexture, 0);
    ...
    public void drawGL(GL gl, int textureLoc) {
        ...
        for (int i = 0; i < segments.size(); i++) {
            ...
            if (tmpModelSegment.getFaceCount() != 0) { // again with the
                ...
                mtl.beginDrawGL(gl, useMaterial, useTexture, textureLoc);
