...
public class Homography {
    ...
    public Homography(XMLElement homographyXML) {

        XMLElement[] values = homographyXML.getChildren();

        transform = new Matrix4x4(Float.parseFloat(values[0].getContent()),
                Float.parseFloat(values[1].getContent()),
                Float.parseFloat(values[2].getContent()),
                0,
                Float.parseFloat(values[3].getContent()),
                Float.parseFloat(values[4].getContent()),
                Float.parseFloat(values[5].getContent()),
                0,
                Float.parseFloat(values[6].getContent()),
                Float.parseFloat(values[7].getContent()),
                Float.parseFloat(values[8].getContent()),
                0,
                0, 0, 0, 1);

        // TODO: not working... ?!
        transform2D = new PMatrix2D(Float.parseFloat(values[0].getContent()), Float.parseFloat(values[1].getContent()), Float.parseFloat(values[3].getContent()),
                Float.parseFloat(values[4].getContent()), Float.parseFloat(values[5].getContent()), Float.parseFloat(values[7].getContent()));
