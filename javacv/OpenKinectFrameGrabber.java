...
public class OpenKinectFrameGrabber extends FrameGrabber {
    ...
    public void setColorFormat(int bitsPerPixel) {
        this.colorFormat = bitsPerPixel;
    }
    ...
    public IplImage grabDepth() throws Exception {
        int fmt = depthFormat; // default bpp == 0 == FREENECT_DEPTH_11BIT
    ...
    public IplImage grabVideo() throws Exception {
        int fmt = colorFormat; // default bpp == 0 == FREENECT_VIDEO_RGB
